...
//4.适配器模式 将不同的函数封装到一个api中 如数据库 mysql mysqli pdo  缓存  redis  memcache  
$db = Imooc\Database\Mysqli::connect('127.0.0.1','root','root','test');
$res = Imooc\Database\Mysqli::query("SHOW TABLES");
var_dump($res);
Imooc\Database\Mysqli::close(); 
